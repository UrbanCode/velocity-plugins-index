...
import IndexHelper, { FILE_NAME as INDEX_FILE_NAME, ERROR_TEXT as INDEX_ERROR_TEXT } from '../../src/helpers/IndexHelper'
...
import { VALID_IMAGE } from '../func/func-constants'
...
describe('Validate index structure', function() {
  ...
  describe('Invalid Root', function() {
    it('should throw error if index is undefined', function() {
      expect(() => IndexHelper.validate(undefined)).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Root}`)
    })
    it('should throw error if index is null', function() {
      expect(() => IndexHelper.validate(null)).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Root}`)
    })
    it('should throw error if index is empty string', function() {
      expect(() => IndexHelper.validate('')).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Root}`)
    })
    it('should throw error if index is string', function() {
      expect(() => IndexHelper.validate('plugins')).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Root}`)
    })
    it('should throw error if index is number', function() {
      expect(() => IndexHelper.validate(10)).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Root}`)
    })
    it('should throw error if index is array', function() {
      expect(() => IndexHelper.validate([validPlugin])).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Root}`)
    })
    it('should throw error if index is boolean', function() {
      expect(() => IndexHelper.validate(true)).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Root}`)
    })
  })
  describe('Invalid Root Elements', function() {
    it('should throw error if root element is undefined', function() {
      expect(() => IndexHelper.validate(JSON.stringify(`{undefined: ${JSON.stringify(validPlugin)}}`))).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Root}`)
    })
    it('should throw error if root element is null', function() {
      expect(() => IndexHelper.validate(JSON.stringify(`{null: ${JSON.stringify(validPlugin)}}`))).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Root}`)
    })
    it('should throw error if root element is empty string', function() {
      expect(() => IndexHelper.validate({'': validPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Root}`)
    })
    it('should throw error if root element is number', function() {
      expect(() => IndexHelper.validate(JSON.stringify(`{7: ${JSON.stringify(validPlugin)}}`))).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Root}`)
    })
    it('should throw error if root element is array', function() {
      expect(() => IndexHelper.validate(JSON.stringify(`{['pluginId']: ${JSON.stringify(validPlugin)}}`))).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Root}`)
    })
    it('should throw error if root element is boolean', function() {
      expect(() => IndexHelper.validate(JSON.stringify(`{true: ${JSON.stringify(validPlugin)}}`))).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Root}`)
    })
  })
  describe('Invalid Plugin', function() {
    it('should throw error if plugin object is undefined', function() {
      expect(() => IndexHelper.validate({'custom-plugin': undefined})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Plugin}`)
    })
    it('should throw error if plugin object is null', function() {
      expect(() => IndexHelper.validate({'custom-plugin': null})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Plugin}`)
    })
    it('should throw error if plugin object is empty string', function() {
      expect(() => IndexHelper.validate({'custom-plugin': ''})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Plugin}`)
    })
    it('should throw error if plugin object is string', function() {
      expect(() => IndexHelper.validate({'custom-plugin': 'i am a plugin'})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Plugin}`)
    })
    it('should throw error if plugin object is number', function() {
      expect(() => IndexHelper.validate({'custom-plugin': 6})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Plugin}`)
    })
    it('should throw error if plugin object is array', function() {
      expect(() => IndexHelper.validate({'custom-plugin': [validPlugin]})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Plugin}`)
    })
    it('should throw error if plugin object is boolean', function() {
      expect(() => IndexHelper.validate({'custom-plugin': true})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Plugin}`)
    })
  })
  describe('Invalid Plugin Info', function() {
    describe('Name', function() {
      it('should throw error if missing name', function() {
        ...
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INFO_ERROR_TEXT.Name}`)
      })
    ...
    describe('Url', function() {
      it('should throw error if missing url', function() {
        ...
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INFO_ERROR_TEXT.Url}`)
      })
    ...
    describe('Description', function() {
      it('should throw error if missing description', function() {
        ...
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INFO_ERROR_TEXT.Description}`)
      })
    ...
    describe('Author', function() {
      it('should throw error if missing author', function() {
        ...
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INFO_ERROR_TEXT.Author}`)
      })
      ...
      it('should throw error if author is empty object', function() {
        let badInfoPlugin = JSON.parse(JSON.stringify(validPlugin))
        badInfoPlugin.author = {}
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INFO_ERROR_TEXT.AuthorName} AND ${INFO_ERROR_TEXT.AuthorEmail}`)
      })
    })
    describe('Author Name', function() {
      it('should throw error if missing author name', function() {
        ...
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INFO_ERROR_TEXT.AuthorName}`)
      })
    ...
    describe('Author Email', function() {
      it('should throw error if missing author email', function() {
        ...
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INFO_ERROR_TEXT.AuthorEmail}`)
      })
  ...
  describe('Invalid Current Release', function() {
    describe('Root', function() {
      it('should throw error if missing current key', function() {
        ...
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${INDEX_ERROR_TEXT.Current}`)
      })
    ...
    describe('Semver', function() {
      it('should throw error if missing semver', function() {
        ...
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${RELEASES_ERROR_TEXT.Semver}`)
      })
    ...
    describe('Date', function() {
      it('should throw error if missing date', function() {
        ...
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${RELEASES_ERROR_TEXT.Date}`)
      })
    ...
    describe('Image', function() {
      it('should throw error if missing image', function() {
        ...
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${RELEASES_ERROR_TEXT.Image}`)
      })
      ...
      it('should throw error if image empty string', function() {
        ...
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${RELEASES_ERROR_TEXT.Image} AND ${RELEASES_ERROR_TEXT.ImageLatest}`)
      })
      ...
      it('should throw error if image does not exist in DockerHub', function() {
        imageStub.restore()
        imageStub = sinon.stub(DockerHelper, 'doesImageExist').returns(false)
        expect(() => IndexHelper.validate({'custom-plugin': validPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${RELEASES_ERROR_TEXT.ImageExists}`)
      })
      it('should throw error if releases has docker image without explicit tag', function() {
        let badInfoPlugin = JSON.parse(JSON.stringify(validPlugin))
        badInfoPlugin.current.image = VALID_IMAGE.substring(0, VALID_IMAGE.indexOf(':'))
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${RELEASES_ERROR_TEXT.ImageLatest}`)
      })
      it('should throw error if releases has docker image with latest tag', function() {
        let badInfoPlugin = JSON.parse(JSON.stringify(validPlugin))
        badInfoPlugin.current.image = `${VALID_IMAGE.substring(0, VALID_IMAGE.indexOf(':'))}:latest`
        expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${RELEASES_ERROR_TEXT.ImageLatest}`)
      })
    })
    describe('Notes', function() {
      describe('Root', function() {
        it('should throw error if missing notes', function() {
          ...
          expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${RELEASES_ERROR_TEXT.NotesArray}`)
        })
      ...
      describe('Elements', function() {
        ...
        it('should throw error if note null', function() {
          let badInfoPlugin = JSON.parse(JSON.stringify(validPlugin))
          badInfoPlugin.current.notes = [null]
          expect(() => IndexHelper.validate({'custom-plugin': badInfoPlugin})).throws(Error).with.property('message', `Invalid JSON in "${INDEX_FILE_NAME}": ${RELEASES_ERROR_TEXT.NotesObject}`)
        })
