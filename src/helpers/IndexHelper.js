...
export const ERROR_TEXT = {
  Root: 'must have root JSON object for index containing elements for each pluginId whose value is a JSON object containing elements for the plugins info along with a "current" element whose value is a release object containing the latest release of the plugin',
  Plugin: 'must have string elements for each pluginId in the root JSON object whose value is a JSON object containing elements for the plugins info along with a "current" element whose value is a release object containing the latest release of the plugin',
